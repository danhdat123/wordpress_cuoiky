...
2. Type in Golf Course in the search form and press the 'Enter' key on your keyboard.
...
Golf Course WordPress Theme is derived from Twenty Seventeen WordPress Theme, Copyright 2016 WordPress.org
Twenty Seventeen is distributed under the terms of the GNU GPL

Golf Course bundles the following third-party resources:

* CSS bootstrap.css, License: Copyright 2011-2018 The Bootstrap Authors, Source: https://gitcourse.com/twbs/bootstrap/blob/master/LICENSE

* JS bootstrap.js, License: Copyright 2011-2018 The Bootstrap Authors (https://gitcourse.com/twbs/bootstrap/graphs/contributors), Source: https://gitcourse.com/twbs/bootstrap/blob/master/LICENSE
...
* JS Superfish, License: https://gitcourse.com/joeldbirch/superfishWebfonts Loader

* License: https://gitcourse.com/WPTT/webfont-loader/blob/master/LICENSE Source: https://gitcourse.com/WPTT/webfont-loader

* Stocksnap Images, License: CC0 1.0 Universal (CC0 1.0), Source: https://stocksnap.io/license

* Banner image: Copyright Daniel Frank, License: CC0 1.0 Universal (CC0 1.0), Source: https://stocksnap.io/photo/golf-ball-FAEOPECD4T

* Post image: Copyright Brodie Vissers, License: CC0 1.0 Universal (CC0 1.0), Source: https://stocksnap.io/photo/golf-cart-CJAFXP1UQV

* Post image: Copyright Brodie Vissers, License: CC0 1.0 Universal (CC0 1.0), Source: https://stocksnap.io/photo/woman-golfer-A4XHGDNAFO
